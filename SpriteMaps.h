...
*/enum enumObjectSprites{
  ...
  SPRITEOBJECT_DEAD_TREE = 9,
	...
	SPRITEOBJECT_WATERLEVEL3 = 22,
	SPRITEOBJECT_WATERLEVEL4 = 23,
	SPRITEOBJECT_WATERLEVEL5 = 24,
	SPRITEOBJECT_WATERLEVEL6 = 25,
	SPRITEOBJECT_WATERLEVEL7 = 26,
	

	SPRITEOBJECT_DOORROCK = 40,
	SPRITEOBJECT_DOORWOOD = 41,
  SPRITEOBJECT_DOORWOOD_WILLOW = 42,
  SPRITEOBJECT_DOORROCK_MIR = 43,
	SPRITEOBJECT_DOORWOOD_MIR = 44,
  SPRITEOBJECT_DOORWOOD_WILLOW_MIR = 45,
  ...
  SPRITEOBJECT_WALL_NA = 0,
  SPRITEOBJECT_WALL_STONE_ROUGH = 1,
  SPRITEOBJECT_WALL_MINSTONE_ROUGH = 2,
  SPRITEOBJECT_WALL_LAVASTONE_ROUGH = 3,
  SPRITEOBJECT_WALL_FEATSTONE_ROUGH = 4,
  SPRITEOBJECT_WALL_SOIL = 5,
  SPRITEOBJECT_WALL_FROZEN = 6,
  SPRITEOBJECT_WALL_METAL = 7,
	SPRITEOBJECT_WALL_WOOD = 8,
  SPRITEOBJECT_WALL_WOOD_FORTIFICATION = 9,
  SPRITEOBJECT_WALL_SAND_YELLOW = 10,
  SPRITEOBJECT_WALL_SAND_RED = 11,
  SPRITEOBJECT_WALL_SAND_BLACK = 12,
  SPRITEOBJECT_WALL_SAND_WHITE = 13,

	SPRITEOBJECT_WALL_STONE_SMOOTH = 20,
  //SPRITEOBJECT_WALL_CONSTR_SMOOTH = 73,
  SPRITEOBJECT_WALL_CONSTR = 22,
  SPRITEOBJECT_WALL_PILLAR = 23,
  SPRITEOBJECT_WALL_FORTIFICATION = 24,
  SPRITEOBJECT_WALL_CONSTR_FORTIFICATION = 25,
