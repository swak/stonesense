...
enum BlockIDs{
  ...
  ID_CNSTR_RAMP = 518,
	...
	//new ones
	ID_CNSTR_STAIR_UPDOWN_MIRRORED = MAX_BASE_TERRAIN+1,
	ID_CNSTR_STAIR_UP_MIRRORED = MAX_BASE_TERRAIN+2,
	//this works because there is only one constructed ramp type
	ID_RAMPTOP = MAX_BASE_TERRAIN+3,
	ID_CNSTR_RAMPTOP = MAX_BASE_TERRAIN+4,
